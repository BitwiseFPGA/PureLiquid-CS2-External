	...
	namespace SchemaOffsets {
		namespace server {
			...
			namespace CCSGameRules /*: public CS2::server::CTeamplayRules*/ {
				...
				constexpr std::ptrdiff_t m_bBombPlanted = 0x94f; // bool m_bBombPlanted; |  0x94f | Schema_Builtin | Size: 0x1
				...
				constexpr std::ptrdiff_t m_CTSpawnPointsMasterList = 0xf50; // server::CUtlVector<GlobalTypes::CHandle<server::SpawnPoint>>  | Schema_Atomic | Size: 0x18
				constexpr std::ptrdiff_t m_TerroristSpawnPointsMasterList = 0xf68; // server::CUtlVector<GlobalTypes::CHandle<server::SpawnPoint>>  | Schema_Atomic | Size: 0x18
				...
				constexpr std::ptrdiff_t m_CTSpawnPoints = 0xf98; // server::CUtlVector<GlobalTypes::CHandle<server::SpawnPoint>>  | Schema_Atomic | Size: 0x18
				constexpr std::ptrdiff_t m_TerroristSpawnPoints = 0xfb0; // server::CUtlVector<GlobalTypes::CHandle<server::SpawnPoint>>  | Schema_Atomic | Size: 0x18
