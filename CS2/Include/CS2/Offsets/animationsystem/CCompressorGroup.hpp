	...
	namespace SchemaOffsets {
		namespace animationsystem {
			...
			namespace CCompressorGroup /**/ {
				...
				constexpr std::ptrdiff_t m_vectorCompressor = 0xf8; // GlobalTypes::CUtlVector<��^�::CCompressor*>  | Schema_Atomic | Size: 0x18
				constexpr std::ptrdiff_t m_quaternionCompressor = 0x110; // GlobalTypes::CUtlVector<��^�::CCompressor*>  | Schema_Atomic | Size: 0x18
				constexpr std::ptrdiff_t m_intCompressor = 0x128; // GlobalTypes::CUtlVector<��^�::CCompressor*>  | Schema_Atomic | Size: 0x18
				constexpr std::ptrdiff_t m_boolCompressor = 0x140; // GlobalTypes::CUtlVector<��^�::CCompressor*>  | Schema_Atomic | Size: 0x18
				constexpr std::ptrdiff_t m_colorCompressor = 0x158; // GlobalTypes::CUtlVector<��^�::CCompressor*>  | Schema_Atomic | Size: 0x18
				constexpr std::ptrdiff_t m_vector2DCompressor = 0x170; // GlobalTypes::CUtlVector<��^�::CCompressor*>  | Schema_Atomic | Size: 0x18
				constexpr std::ptrdiff_t m_vector4DCompressor = 0x188; // GlobalTypes::CUtlVector<��^�::CCompressor*>  | Schema_Atomic | Size: 0x18
			}
		}
	}
}
