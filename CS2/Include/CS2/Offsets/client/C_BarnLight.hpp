	...
	namespace SchemaOffsets {
		namespace client {
			...
			namespace C_BarnLight /*: public CS2::client::C_BaseModelEntity*/ {
				...
				constexpr std::ptrdiff_t m_LightStyleTargets = 0xf28; // GlobalTypes::C_NetworkUtlVectorBase<GlobalTypes::CHandle<client::C_BaseModelEntity>>  | Schema_Atomic | Size: 0x18
