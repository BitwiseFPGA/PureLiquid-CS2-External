	...
	namespace SchemaOffsets {
		namespace client {
			...
			namespace C_BaseModelEntity /*: public CS2::client::C_BaseEntity*/ {
				...
				constexpr std::ptrdiff_t m_vecRenderAttributes = 0xb78; // GlobalTypes::C_UtlVectorEmbeddedNetworkVar<client::EntityRenderAttribute_t>  | Schema_Atomic | Size: 0x68
				...
				constexpr std::ptrdiff_t m_ConfigEntitiesToPropagateMaterialDecalsTo = 0xd40; // GlobalTypes::C_NetworkUtlVectorBase<GlobalTypes::CHandle<client::C_BaseModelEntity>>  | Schema_Atomic | Size: 0x18
