	...
	namespace SchemaOffsets {
		namespace client {
			...
			namespace C_CSPlayerPawn /*: public CS2::client::C_CSPlayerPawnBase*/ {
				constexpr std::ptrdiff_t m_pBulletServices = 0x1678; // client::CCSPlayer_BulletServices**  | Schema_Ptr | Size: 0x8
				constexpr std::ptrdiff_t m_pHostageServices = 0x1680; // client::CCSPlayer_HostageServices**  | Schema_Ptr | Size: 0x8
				constexpr std::ptrdiff_t m_pBuyServices = 0x1688; // client::CCSPlayer_BuyServices**  | Schema_Ptr | Size: 0x8
				constexpr std::ptrdiff_t m_pGlowServices = 0x1690; // client::CCSPlayer_GlowServices**  | Schema_Ptr | Size: 0x8
				constexpr std::ptrdiff_t m_pActionTrackingServices = 0x1698; // client::CCSPlayer_ActionTrackingServices**  | Schema_Ptr | Size: 0x8
				constexpr std::ptrdiff_t m_pDamageReactServices = 0x16a0; // client::CCSPlayer_DamageReactServices**  | Schema_Ptr | Size: 0x8
				constexpr std::ptrdiff_t m_flHealthShotBoostExpirationTime = 0x16a8; // entity2::GameTime_t  | Schema_DeclaredClass | Size: 0x4
				constexpr std::ptrdiff_t m_flLastFiredWeaponTime = 0x16ac; // entity2::GameTime_t  | Schema_DeclaredClass | Size: 0x4
				...
				constexpr std::ptrdiff_t m_aimPunchAngle = 0x16e4; // GlobalTypes::QAngle  | Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_aimPunchAngleVel = 0x16f0; // GlobalTypes::QAngle  | Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_aimPunchTickBase = 0x16fc; // entity2::GameTick_t  | Schema_DeclaredClass | Size: 0x4
				constexpr std::ptrdiff_t m_aimPunchTickFraction = 0x1700; // float32 m_aimPunchTickFraction; |  0x1700 | Schema_Builtin | Size: 0x4
				constexpr std::ptrdiff_t m_aimPunchCache = 0x1708; // GlobalTypes::CUtlVector<GlobalTypes::QAngle>  | Schema_Atomic | Size: 0x18
				...
				constexpr std::ptrdiff_t m_flTimeOfLastInjury = 0x1734; // entity2::GameTime_t  | Schema_DeclaredClass | Size: 0x4
				constexpr std::ptrdiff_t m_flNextSprayDecalTime = 0x1738; // entity2::GameTime_t  | Schema_DeclaredClass | Size: 0x4
				...
				constexpr std::ptrdiff_t m_RetakesMVPBoostExtraUtility = 0x18a0; // client::loadout_slot_t  | Schema_DeclaredEnum | Size: 0x4
				constexpr std::ptrdiff_t m_bNeedToReApplyGloves = 0x18a5; // bool m_bNeedToReApplyGloves; |  0x18a5 | Schema_Builtin | Size: 0x1
				constexpr std::ptrdiff_t m_EconGloves = 0x18a8; // client::C_EconItemView  | Schema_DeclaredClass | Size: 0x478
				...
				constexpr std::ptrdiff_t m_vRagdollDamageForce = 0x1d28; // GlobalTypes::Vector  | Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_vRagdollDamagePosition = 0x1d34; // GlobalTypes::Vector  | Schema_Atomic | Size: 0xc
				...
				constexpr std::ptrdiff_t m_vRagdollServerOrigin = 0x1d84; // GlobalTypes::Vector  | Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_lastLandTime = 0x2400; // entity2::GameTime_t  | Schema_DeclaredClass | Size: 0x4
				constexpr std::ptrdiff_t m_bOnGroundLastTick = 0x2404; // bool m_bOnGroundLastTick; |  0x2404 | Schema_Builtin | Size: 0x1
				constexpr std::ptrdiff_t m_hHudModelArms = 0x2420; // GlobalTypes::CHandle<client::C_CS2HudModelArms>  | Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_qDeathEyeAngles = 0x2424; // GlobalTypes::QAngle  | Schema_Atomic | Size: 0xc
				...
				constexpr std::ptrdiff_t m_fSwitchedHandednessTime = 0x2434; // entity2::GameTime_t  | Schema_DeclaredClass | Size: 0x4
				...
				constexpr std::ptrdiff_t m_GunGameImmunityColor = 0x2480; // GlobalTypes::Color  | Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_vecBulletHitModels = 0x24d0; // GlobalTypes::CUtlVector<client::C_BulletHitModel*>  | Schema_Atomic | Size: 0x18
				constexpr std::ptrdiff_t m_bIsWalking = 0x24e8; // bool m_bIsWalking; |  0x24e8 | Schema_Builtin | Size: 0x1
				constexpr std::ptrdiff_t m_thirdPersonHeading = 0x24f0; // GlobalTypes::QAngle  | Schema_Atomic | Size: 0xc
				...
				constexpr std::ptrdiff_t m_vHeadConstraintOffset = 0x2670; // GlobalTypes::Vector  | Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_entitySpottedState = 0x2700; // client::EntitySpottedState_t  | Schema_DeclaredClass | Size: 0x18
				...
				constexpr std::ptrdiff_t m_iBlockingUseActionInProgress = 0x271c; // client::CSPlayerBlockingUseAction_t  | Schema_DeclaredEnum | Size: 0x4
				constexpr std::ptrdiff_t m_flEmitSoundTime = 0x2720; // entity2::GameTime_t  | Schema_DeclaredClass | Size: 0x4
				...
				constexpr std::ptrdiff_t m_nLastKillerIndex = 0x2758; // GlobalTypes::CEntityIndex  | Schema_Atomic | Size: 0x4
				...
				constexpr std::ptrdiff_t m_vecDeathInfoOrigin = 0x2764; // GlobalTypes::Vector  | Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_grenadeParameterStashTime = 0x2774; // entity2::GameTime_t  | Schema_DeclaredClass | Size: 0x4
				...
				constexpr std::ptrdiff_t m_angStashedShootAngles = 0x277c; // GlobalTypes::QAngle  | Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_vecStashedGrenadeThrowPosition = 0x2788; // GlobalTypes::Vector  | Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_vecStashedVelocity = 0x2794; // GlobalTypes::Vector  | Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_angShootAngleHistory = 0x27a0; // GlobalTypes::QAngle[2]  | Schema_FixedArray | Size: 0x18
				constexpr std::ptrdiff_t m_vecThrowPositionHistory = 0x27b8; // GlobalTypes::Vector[2]  | Schema_FixedArray | Size: 0x18
				constexpr std::ptrdiff_t m_vecVelocityHistory = 0x27d0; // GlobalTypes::Vector[2]  | Schema_FixedArray | Size: 0x18
				constexpr std::ptrdiff_t m_PredictedDamageTags = 0x27e8; // GlobalTypes::C_UtlVectorEmbeddedNetworkVar<client::PredictedDamageTag_t>  | Schema_Atomic | Size: 0x68
				constexpr std::ptrdiff_t m_nPrevHighestReceivedDamageTagTick = 0x2850; // entity2::GameTick_t  | Schema_DeclaredClass | Size: 0x4
				...
				constexpr std::ptrdiff_t m_fImmuneToGunGameDamageTime = 0x3d90; // entity2::GameTime_t  | Schema_DeclaredClass | Size: 0x4
				constexpr std::ptrdiff_t m_bGunGameImmunity = 0x3d94; // bool m_bGunGameImmunity; |  0x3d94 | Schema_Builtin | Size: 0x1
				constexpr std::ptrdiff_t m_fImmuneToGunGameDamageTimeLast = 0x3d98; // entity2::GameTime_t  | Schema_DeclaredClass | Size: 0x4
				constexpr std::ptrdiff_t m_fMolotovDamageTime = 0x3d9c; // float32 m_fMolotovDamageTime; |  0x3d9c | Schema_Builtin | Size: 0x4
				constexpr std::ptrdiff_t m_vecLastAliveLocalVelocity = 0x3da4; // GlobalTypes::Vector  | Schema_Atomic | Size: 0xc
				...
				constexpr std::ptrdiff_t m_vecLastClipCameraPos = 0x3dc4; // GlobalTypes::Vector  | Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_vecLastClipCameraForward = 0x3dd0; // GlobalTypes::Vector  | Schema_Atomic | Size: 0xc
				...
				constexpr std::ptrdiff_t m_pClippingWeapon = 0x3de0; // client::C_CSWeaponBase**  | Schema_Ptr | Size: 0x8
				constexpr std::ptrdiff_t m_nPlayerInfernoBodyFx = 0x3de8; // client::ParticleIndex_t  | Schema_DeclaredClass | Size: 0x4
				constexpr std::ptrdiff_t m_angEyeAngles = 0x3df0; // GlobalTypes::QAngle  | Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_arrOldEyeAnglesTimes = 0x3e80; // GlobalTypes::GameTime_t[4]  | Schema_FixedArray | Size: 0x40
				constexpr std::ptrdiff_t m_arrOldEyeAngles = 0x3e90; // GlobalTypes::QAngle[4]  | Schema_FixedArray | Size: 0x30
				constexpr std::ptrdiff_t m_angEyeAnglesVelocity = 0x3ec0; // GlobalTypes::QAngle  | Schema_Atomic | Size: 0xc
				constexpr std::ptrdiff_t m_iIDEntIndex = 0x3ecc; // GlobalTypes::CEntityIndex  | Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_delayTargetIDTimer = 0x3ed0; // client::CountdownTimer  | Schema_DeclaredClass | Size: 0x18
				constexpr std::ptrdiff_t m_iTargetItemEntIdx = 0x3ee8; // GlobalTypes::CEntityIndex  | Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_iOldIDEntIndex = 0x3eec; // GlobalTypes::CEntityIndex  | Schema_Atomic | Size: 0x4
				constexpr std::ptrdiff_t m_holdTargetIDTimer = 0x3ef0; // client::CountdownTimer  | Schema_DeclaredClass | Size: 0x18
			}
		}
	}
}
