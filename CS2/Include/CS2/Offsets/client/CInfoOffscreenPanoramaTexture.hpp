	...
	namespace SchemaOffsets {
		namespace client {
			...
			namespace CInfoOffscreenPanoramaTexture /*: public CS2::client::C_PointEntity*/ {
				...
				constexpr std::ptrdiff_t m_TargetEntities = 0x618; // GlobalTypes::C_NetworkUtlVectorBase<GlobalTypes::CHandle<client::C_BaseModelEntity>>  | Schema_Atomic | Size: 0x18
