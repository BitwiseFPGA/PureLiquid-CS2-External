	...
	namespace SchemaOffsets {
		namespace client {
			...
			namespace CPlayer_CameraServices /*: public CS2::client::CPlayerPawnComponent*/ {
				...
				constexpr std::ptrdiff_t m_PostProcessingVolumes = 0x128; // GlobalTypes::C_NetworkUtlVectorBase<GlobalTypes::CHandle<client::C_PostProcessingVolume>>  | Schema_Atomic | Size: 0x18
