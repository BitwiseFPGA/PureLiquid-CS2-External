...
namespace CS2 {
	namespace materialsystem2 {
		...
		public:
			...
			PROPERTY(m_toneMapParams,materialsystem2::PostProcessingTonemapParameters_t , 0x4);
			PROPERTY(m_bHasBloomParams,bool , 0x40);
			PROPERTY(m_bloomParams,materialsystem2::PostProcessingBloomParameters_t , 0x44);
			PROPERTY(m_bHasVignetteParams,bool , 0xcc);
			PROPERTY(m_vignetteParams,materialsystem2::PostProcessingVignetteParameters_t , 0xd0);
			PROPERTY(m_bHasLocalContrastParams,bool , 0xf4);
			PROPERTY(m_localConstrastParams,materialsystem2::PostProcessingLocalContrastParameters_t , 0xf8);
			...
			PROPERTY(m_fogScatteringParams,materialsystem2::PostProcessingFogScatteringParameters_t , 0x124);
			S2_PAD(0x138);
		};
