...
namespace CS2 {
	namespace particles {
		...
		public:
			...
			PROPERTY(m_nAttributeToRead,particles::ParticleAttributeIndex_t , 0x1e8);
			PROPERTY(m_nAttributeToWrite,particles::ParticleAttributeIndex_t , 0x1ec);
			PROPERTY(m_nLocalSpaceCP,int32_t , 0x1f0);
			PROPERTY(m_bRandom,bool , 0x1f4);
			PROPERTY(m_bReverse,bool , 0x1f5);
			PROPERTY(m_nSnapShotIncrement,particleslib::CParticleCollectionFloatInput , 0x1f8);
			PROPERTY(m_nManualSnapshotIndex,particleslib::CPerParticleFloatInput , 0x368);
