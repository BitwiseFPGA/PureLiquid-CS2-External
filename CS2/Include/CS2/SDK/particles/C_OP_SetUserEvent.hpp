...
namespace CS2 {
	namespace particles {
		...
		public:
			PROPERTY(m_flInput,particleslib::CPerParticleFloatInput , 0x1d0);
			PROPERTY(m_flRisingEdge,particleslib::CPerParticleFloatInput , 0x340);
			PROPERTY(m_nRisingEventType,particles::EventTypeSelection_t , 0x4b0);
			PROPERTY(m_flFallingEdge,particleslib::CPerParticleFloatInput , 0x4b8);
