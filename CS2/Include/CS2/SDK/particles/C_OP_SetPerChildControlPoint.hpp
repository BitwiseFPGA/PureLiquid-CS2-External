...
namespace CS2 {
	namespace particles {
		...
		public:
			...
			PROPERTY(m_nParticleIncrement,particleslib::CParticleCollectionFloatInput , 0x1e0);
			PROPERTY(m_nFirstSourcePoint,particleslib::CParticleCollectionFloatInput , 0x350);
			PROPERTY(m_bSetOrientation,bool , 0x4c0);
			PROPERTY(m_nOrientationField,particles::ParticleAttributeIndex_t , 0x4c4);
