...
namespace CS2 {
	namespace particles {
		...
		public:
			...
			PROPERTY(m_nSndLvlField,particles::ParticleAttributeIndex_t , 0x230);
			PROPERTY(m_nDurationField,particles::ParticleAttributeIndex_t , 0x234);
			PROPERTY(m_nPitchField,particles::ParticleAttributeIndex_t , 0x238);
			PROPERTY(m_nVolumeField,particles::ParticleAttributeIndex_t , 0x23c);
