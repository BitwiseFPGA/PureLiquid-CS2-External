...
namespace CS2 {
	namespace particles {
		...
		public:
			...
			PROPERTY(m_flOutputMin,float32 , 0x1d4);
			PROPERTY(m_flOutputMax,float32 , 0x1d8);
			PROPERTY(m_fl4NoiseScale,float32 , 0x1dc);
			PROPERTY(m_bAdditive,bool , 0x1e0);
			PROPERTY(m_flNoiseAnimationTimeScale,float32 , 0x1e4);
			S2_PAD(0x18);
		};
