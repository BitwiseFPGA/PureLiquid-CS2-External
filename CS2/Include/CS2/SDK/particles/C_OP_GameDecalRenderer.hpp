...
namespace CS2 {
	namespace particles {
		...
		public:
			...
			PROPERTY(m_vecStartPos,particleslib::CPerParticleVecInput , 0x240);
			PROPERTY(m_vecEndPos,particleslib::CPerParticleVecInput , 0x8f8);
			PROPERTY(m_flTraceBloat,particleslib::CPerParticleFloatInput , 0xfb0);
			PROPERTY(m_flDecalSize,particleslib::CPerParticleFloatInput , 0x1120);
			PROPERTY(m_nDecalGroupIndex,particleslib::CPerParticleFloatInput , 0x1290);
			PROPERTY(m_flDecalRotation,particleslib::CPerParticleFloatInput , 0x1400);
			PROPERTY(m_vModulationColor,particleslib::CPerParticleVecInput , 0x1570);
