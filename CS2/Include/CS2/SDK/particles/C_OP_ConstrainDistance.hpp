...
namespace CS2 {
	namespace particles {
		...
		public:
			NESTED_PROPERTY(m_fMinDistance,IDENTITY(particleslib::CParticleCollectionFloatInput), 0x1d0);
			NESTED_PROPERTY(m_fMaxDistance,IDENTITY(particleslib::CParticleCollectionFloatInput), 0x340);
