...
namespace CS2 {
	namespace particles {
		...
		public:
			...
			PROPERTY(m_vecColorScale,particleslib::CParticleCollectionVecInput , 0x228);
			PROPERTY(m_nColorBlendType,particles::ParticleColorBlendType_t , 0x8e0);
			PROPERTY(m_flIntensity,particleslib::CParticleCollectionFloatInput , 0x8e8);
			PROPERTY(m_bCastShadows,bool , 0xa58);
			PROPERTY(m_flTheta,particleslib::CParticleCollectionFloatInput , 0xa60);
			PROPERTY(m_flPhi,particleslib::CParticleCollectionFloatInput , 0xbd0);
			PROPERTY(m_flRadiusMultiplier,particleslib::CParticleCollectionFloatInput , 0xd40);
			PROPERTY(m_nAttenuationStyle,particles::StandardLightingAttenuationStyle_t , 0xeb0);
			PROPERTY(m_flFalloffLinearity,particleslib::CParticleCollectionFloatInput , 0xeb8);
			PROPERTY(m_flFiftyPercentFalloff,particleslib::CParticleCollectionFloatInput , 0x1028);
			PROPERTY(m_flZeroPercentFalloff,particleslib::CParticleCollectionFloatInput , 0x1198);
			...
			PROPERTY(m_flFogContribution,particleslib::CParticleCollectionRendererFloatInput , 0x1320);
			...
			PROPERTY(m_nPrevPntSource,particles::ParticleAttributeIndex_t , 0x149c);
