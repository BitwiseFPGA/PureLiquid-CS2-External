...
namespace CS2 {
	namespace particles {
		...
		public:
			...
			PROPERTY(m_flTextureVWorldSize,particleslib::CParticleCollectionRendererFloatInput , 0x2e18);
			PROPERTY(m_flTextureVScrollRate,particleslib::CParticleCollectionRendererFloatInput , 0x2f88);
			PROPERTY(m_flTextureVOffset,particleslib::CParticleCollectionRendererFloatInput , 0x30f8);
			...
			PROPERTY(m_nScalarFieldForTextureCoordinate,particles::ParticleAttributeIndex_t , 0x3288);
			...
			PROPERTY(m_nSplitField,particles::ParticleAttributeIndex_t , 0x3294);
			PROPERTY(m_bSortBySegmentID,bool , 0x3298);
			PROPERTY(m_nOrientationType,particles::ParticleOrientationChoiceList_t , 0x329c);
			PROPERTY(m_nVectorFieldForOrientation,particles::ParticleAttributeIndex_t , 0x32a0);
