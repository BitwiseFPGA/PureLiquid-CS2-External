...
namespace CS2 {
	namespace particles {
		...
		public:
			NESTED_PROPERTY(m_flEmissionDuration,IDENTITY(particleslib::CParticleCollectionFloatInput), 0x1d8);
			NESTED_PROPERTY(m_flStartTime,IDENTITY(particleslib::CParticleCollectionFloatInput), 0x348);
			NESTED_PROPERTY(m_flEmitRate,IDENTITY(particleslib::CParticleCollectionFloatInput), 0x4b8);
			...
			PROPERTY(m_nEventType,IDENTITY(particles::EventTypeSelection_t), 0x634);
