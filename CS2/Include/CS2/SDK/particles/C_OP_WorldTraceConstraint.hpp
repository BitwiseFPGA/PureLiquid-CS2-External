...
namespace CS2 {
	namespace particles {
		...
		public:
			...
			PROPERTY(m_flRadiusScale,particleslib::CPerParticleFloatInput , 0x288);
			PROPERTY(m_flBounceAmount,particleslib::CPerParticleFloatInput , 0x3f8);
			PROPERTY(m_flSlideAmount,particleslib::CPerParticleFloatInput , 0x568);
			PROPERTY(m_flRandomDirScale,particleslib::CPerParticleFloatInput , 0x6d8);
			...
			PROPERTY(m_nStickOnCollisionField,particles::ParticleAttributeIndex_t , 0x854);
			PROPERTY(m_flStopSpeed,particleslib::CPerParticleFloatInput , 0x858);
			PROPERTY(m_nEntityStickDataField,particles::ParticleAttributeIndex_t , 0x9c8);
			PROPERTY(m_nEntityStickNormalField,particles::ParticleAttributeIndex_t , 0x9cc);
			S2_PAD(0x800);
		};
