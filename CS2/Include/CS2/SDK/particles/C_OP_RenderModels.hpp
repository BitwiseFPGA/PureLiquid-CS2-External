...
namespace CS2 {
	namespace particles {
		...
		public:
			...
			PROPERTY(m_ModelList,GlobalTypes::CUtlVector<particles::ModelReference_t>, 0x228);
			PROPERTY(m_nBodyGroupField,particles::ParticleAttributeIndex_t , 0x240);
			PROPERTY(m_nSubModelField,particles::ParticleAttributeIndex_t , 0x244);
			PROPERTY(m_bIgnoreNormal,bool , 0x248);
			PROPERTY(m_bOrientZ,bool , 0x249);
			PROPERTY(m_bCenterOffset,bool , 0x24a);
			PROPERTY(m_vecLocalOffset,particleslib::CPerParticleVecInput , 0x250);
			PROPERTY(m_vecLocalRotation,particleslib::CPerParticleVecInput , 0x908);
			PROPERTY(m_bIgnoreRadius,bool , 0xfc0);
			PROPERTY(m_nModelScaleCP,int32_t , 0xfc4);
			PROPERTY(m_vecComponentScale,particleslib::CPerParticleVecInput , 0xfc8);
			PROPERTY(m_bLocalScale,bool , 0x1680);
			PROPERTY(m_nSizeCullBloat,int32_t , 0x1684);
			PROPERTY(m_bAnimated,bool , 0x1688);
			PROPERTY(m_flAnimationRate,particleslib::CPerParticleFloatInput , 0x1690);
			...
			PROPERTY(m_nAnimationScaleField,particles::ParticleAttributeIndex_t , 0x1804);
			PROPERTY(m_nAnimationField,particles::ParticleAttributeIndex_t , 0x1808);
			PROPERTY(m_nManualFrameField,particles::ParticleAttributeIndex_t , 0x180c);
			...
			PROPERTY(m_nSkin,particleslib::CPerParticleFloatInput , 0x1a68);
			PROPERTY(m_MaterialVars,GlobalTypes::CUtlVector<particles::MaterialVariable_t>, 0x1bd8);
			PROPERTY(m_flRenderFilter,particleslib::CPerParticleFloatInput , 0x1bf0);
			PROPERTY(m_flManualModelSelection,particleslib::CPerParticleFloatInput , 0x1d60);
			PROPERTY(m_modelInput,particleslib::CParticleModelInput , 0x1ed0);
			...
			PROPERTY(m_flRadiusScale,particleslib::CParticleCollectionFloatInput , 0x2148);
			PROPERTY(m_flAlphaScale,particleslib::CParticleCollectionFloatInput , 0x22b8);
			PROPERTY(m_flRollScale,particleslib::CParticleCollectionFloatInput , 0x2428);
			PROPERTY(m_nAlpha2Field,particles::ParticleAttributeIndex_t , 0x2598);
			PROPERTY(m_vecColorScale,particleslib::CParticleCollectionVecInput , 0x25a0);
