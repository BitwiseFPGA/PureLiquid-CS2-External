...
namespace CS2 {
	namespace particles {
		...
		public:
			PROPERTY(m_nDesiredVelocityCP,int32_t , 0x1d0);
			PROPERTY(m_nLatencyCP,int32_t , 0x1d4);
			PROPERTY(m_nLatencyCPField,int32_t , 0x1d8);
			PROPERTY(m_nDesiredVelocityCPField,int32_t , 0x1dc);
			S2_PAD(0x10);
		};
