...
namespace CS2 {
	namespace particles {
		...
		public:
			...
			PROPERTY(m_nField,particles::ParticleAttributeIndex_t , 0x200);
			...
			PROPERTY(m_flOscMult,particleslib::CPerParticleFloatInput , 0x218);
			PROPERTY(m_flOscAdd,particleslib::CPerParticleFloatInput , 0x388);
			PROPERTY(m_flRateScale,particleslib::CPerParticleFloatInput , 0x4f8);
			S2_PAD(0x498);
		};
