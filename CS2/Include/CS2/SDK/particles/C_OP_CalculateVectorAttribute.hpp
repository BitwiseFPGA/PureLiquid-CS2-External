...
namespace CS2 {
	namespace particles {
		...
		public:
			...
			PROPERTY(m_nFieldInput1,particles::ParticleAttributeIndex_t , 0x1dc);
			PROPERTY(m_flInputScale1,float32 , 0x1e0);
			PROPERTY(m_nFieldInput2,particles::ParticleAttributeIndex_t , 0x1e4);
			PROPERTY(m_flInputScale2,float32 , 0x1e8);
			PROPERTY(m_nControlPointInput1,particles::ControlPointReference_t , 0x1ec);
			PROPERTY(m_flControlPointScale1,float32 , 0x200);
			PROPERTY(m_nControlPointInput2,particles::ControlPointReference_t , 0x204);
			PROPERTY(m_flControlPointScale2,float32 , 0x218);
			PROPERTY(m_nFieldOutput,particles::ParticleAttributeIndex_t , 0x21c);
