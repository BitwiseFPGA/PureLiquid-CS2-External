...
namespace CS2 {
	namespace particles {
		...
		public:
			...
			PROPERTY(m_PreEmissionOperators,GlobalTypes::CUtlVector<particles::CParticleFunctionPreEmission*>, 0x10);
			PROPERTY(m_Emitters,GlobalTypes::CUtlVector<particles::CParticleFunctionEmitter*>, 0x28);
			PROPERTY(m_Initializers,GlobalTypes::CUtlVector<particles::CParticleFunctionInitializer*>, 0x40);
			PROPERTY(m_Operators,GlobalTypes::CUtlVector<particles::CParticleFunctionOperator*>, 0x58);
			PROPERTY(m_ForceGenerators,GlobalTypes::CUtlVector<particles::CParticleFunctionForce*>, 0x70);
			PROPERTY(m_Constraints,GlobalTypes::CUtlVector<particles::CParticleFunctionConstraint*>, 0x88);
			PROPERTY(m_Renderers,GlobalTypes::CUtlVector<particles::CParticleFunctionRenderer*>, 0xa0);
			PROPERTY(m_Children,GlobalTypes::CUtlVector<particles::ParticleChildrenInfo_t>, 0xb8);
			...
			PROPERTY(m_NamedValueLocals,GlobalTypes::CUtlVector<particleslib::ParticleNamedValueSource_t*>, 0x290);
			...
			PROPERTY(m_controlPointConfigurations,GlobalTypes::CUtlVector<particles::ParticleControlPointConfiguration_t>, 0x3b8);
			S2_PAD(0x438);
		};
