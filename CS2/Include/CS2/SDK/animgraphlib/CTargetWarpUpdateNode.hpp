...
namespace CS2 {
	namespace animgraphlib {
		...
		public:
			...
			PROPERTY(m_hTargetPositionParameter,animgraphlib::CAnimParamHandle , 0x78);
			PROPERTY(m_hTargetUpVectorParameter,animgraphlib::CAnimParamHandle , 0x7a);
			PROPERTY(m_hTargetFacePositionParameter,animgraphlib::CAnimParamHandle , 0x7c);
			PROPERTY(m_hMoveHeadingParameter,animgraphlib::CAnimParamHandle , 0x7e);
			PROPERTY(m_hDesiredMoveHeadingParameter,animgraphlib::CAnimParamHandle , 0x80);
