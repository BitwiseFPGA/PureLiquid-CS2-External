...
namespace CS2 {
	namespace compositematerialslib {
		...
		public:
			...
			PROPERTY(m_nSetValue_Value,compositematerialslib::CompositeMaterialInputLooseVariable_t , 0x68);
			...
			PROPERTY(m_vecTexGenInstructions,GlobalTypes::CUtlVector<compositematerialslib::CompMatPropertyMutator_t>, 0x318);
			PROPERTY(m_vecConditionalMutators,GlobalTypes::CUtlVector<compositematerialslib::CompMatPropertyMutator_t>, 0x330);
			...
			PROPERTY(m_vecConditions,GlobalTypes::CUtlVector<compositematerialslib::CompMatMutatorCondition_t>, 0x378);
			S2_PAD(0x390);
		};
