...
namespace CS2 {
	namespace client {
		...
		public:
			...
			PROPERTY(m_iStartAttachment,modellib::AttachmentHandle_t , 0x1154);
			PROPERTY(m_iEndAttachment,modellib::AttachmentHandle_t , 0x1155);
			...
			PROPERTY(m_PhysicsDelegate,client::CPhysicsDelegate , 0x1168);
