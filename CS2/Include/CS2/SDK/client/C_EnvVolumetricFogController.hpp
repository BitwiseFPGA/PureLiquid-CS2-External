...
namespace CS2 {
	namespace client {
		...
		public:
			...
			PROPERTY(m_flStartAnisoTime,entity2::GameTime_t , 0x658);
			PROPERTY(m_flStartScatterTime,entity2::GameTime_t , 0x65c);
			PROPERTY(m_flStartDrawDistanceTime,entity2::GameTime_t , 0x660);
