...
namespace CS2 {
	namespace client {
		...
		public:
			...
			PROPERTY(m_flEffectTime,entity2::GameTime_t , 0x116c);
			PROPERTY(m_gibDespawnTime,entity2::GameTime_t , 0x1170);
			...
			PROPERTY(m_iEyeAttachment,modellib::AttachmentHandle_t , 0x1185);
