...
namespace CS2 {
	namespace client {
		...
		public:
			...
			PROPERTY(m_flEffectTime,entity2::GameTime_t , 0x115c);
			PROPERTY(m_gibDespawnTime,entity2::GameTime_t , 0x1160);
			...
			PROPERTY(m_iEyeAttachment,modellib::AttachmentHandle_t , 0x1175);
			PROPERTY(m_bFadingOut,bool , 0x1176);
			PROPERTY_ARRAY(m_flScaleEnd,float32 , 10 , 0x1178);
			PROPERTY_ARRAY(m_flScaleTimeStart,entity2::GameTime_t , 10 , 0x11a0);
			PROPERTY_ARRAY(m_flScaleTimeEnd,entity2::GameTime_t , 10 , 0x11c8);
			S2_PAD(0x98);
		};
