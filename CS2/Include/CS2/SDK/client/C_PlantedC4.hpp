...
namespace CS2 {
	namespace client {
		...
		public:
			...
			NESTED_PROPERTY(m_entitySpottedState,IDENTITY(client::EntitySpottedState_t), 0x1180);
			NESTED_PROPERTY(m_flNextGlow,IDENTITY(entity2::GameTime_t), 0x1198);
			NESTED_PROPERTY(m_flNextBeep,IDENTITY(entity2::GameTime_t), 0x119c);
			NESTED_PROPERTY(m_flC4Blow,IDENTITY(entity2::GameTime_t), 0x11a0);
			...
			NESTED_PROPERTY(m_flDefuseCountDown,IDENTITY(entity2::GameTime_t), 0x11c0);
			PROPERTY(m_bBombDefused,bool, 0x11c4);
			PROPERTY(m_hBombDefuser,IDENTITY(GlobalTypes::CHandle<client::C_CSPlayerPawn>), 0x11c8);
			NESTED_PROPERTY(m_AttributeManager,IDENTITY(client::C_AttributeContainer), 0x11d0);
			PROPERTY(m_hDefuserMultimeter,IDENTITY(GlobalTypes::CHandle<client::C_Multimeter>), 0x16a0);
			NESTED_PROPERTY(m_flNextRadarFlashTime,IDENTITY(entity2::GameTime_t), 0x16a4);
			PROPERTY(m_bRadarFlash,bool, 0x16a8);
			PROPERTY(m_pBombDefuser,IDENTITY(GlobalTypes::CHandle<client::C_CSPlayerPawn>), 0x16ac);
			NESTED_PROPERTY(m_fLastDefuseTime,IDENTITY(entity2::GameTime_t), 0x16b0);
			PROPERTY(m_pPredictionOwner,IDENTITY(client::CBasePlayerController*), 0x16b8);
