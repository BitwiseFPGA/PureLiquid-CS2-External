...
namespace CS2 {
	namespace client {
		...
		public:
			...
			PROPERTY(m_vecPanelVertices,GlobalTypes::C_NetworkUtlVectorBase<GlobalTypes::Vector2D>, 0x40);
			PROPERTY(m_vInitialPanelVertices,GlobalTypes::C_NetworkUtlVectorBase<GlobalTypes::Vector4D>, 0x58);
