...
namespace CS2 {
	namespace client {
		...
		public:
			...
			// PROPERTY(m_vecPanelVertices,IDENTITY(GlobalTypes::C_NetworkUtlVectorBase<GlobalTypes::Vector2D>), 0x40);
			// PROPERTY(m_vInitialPanelVertices,IDENTITY(GlobalTypes::C_NetworkUtlVectorBase<GlobalTypes::Vector4D>), 0x58);
		...
		//static_assert(sizeof(CS2::client::shard_model_desc_t) == 0x80, "shard_model_desc_t size should be 0x80");
