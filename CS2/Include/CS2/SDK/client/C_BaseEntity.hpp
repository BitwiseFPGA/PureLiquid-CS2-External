...
namespace CS2 {
	namespace client {
		...
		public:
			...
			PROPERTY(m_nLastThinkTick,entity2::GameTick_t , 0x330);
			...
			PROPERTY(m_aThinkFunctions,GlobalTypes::CUtlVector<client::thinkfunc_t>, 0x3a0);
			...
			PROPERTY(m_flCreateTime,entity2::GameTime_t , 0x3e8);
			...
			PROPERTY(m_nNextThinkTick,entity2::GameTick_t , 0x3f8);
			PROPERTY(m_fFlags,uint32_t , 0x400);
			PROPERTY(m_vecAbsVelocity,GlobalTypes::Vector , 0x404);
			PROPERTY(m_vecServerVelocity,client::CNetworkVelocityVector , 0x410);
			PROPERTY(m_vecVelocity,client::CNetworkVelocityVector , 0x438);
			...
			PROPERTY(m_flNavIgnoreUntilTime,entity2::GameTime_t , 0x554);
			...
			PROPERTY(m_Particles,particleslib::CParticleProperty , 0x580);
			PROPERTY(m_vecAngVelocity,GlobalTypes::QAngle , 0x5b0);
			PROPERTY(m_DataChangeEventRef,int32_t , 0x5bc);
			PROPERTY(m_dependencies,GlobalTypes::CUtlVector<GlobalTypes::CEntityHandle>, 0x5c0);
