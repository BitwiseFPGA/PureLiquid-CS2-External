...
namespace CS2 {
	namespace client {
		...
		public:
			...
			PROPERTY(m_flWeaponGameplayAnimStateTimestamp,entity2::GameTime_t , 0x194c);
			PROPERTY(m_flInspectCancelCompleteTime,entity2::GameTime_t , 0x1950);
			...
			PROPERTY(m_OnPlayerPickup,entity2::CEntityIOOutput , 0x1990);
			...
			PROPERTY(m_flLastAccuracyUpdateTime,entity2::GameTime_t , 0x19c4);
			...
			PROPERTY(m_flLastBurstModeChangeTime,entity2::GameTime_t , 0x19d8);
			PROPERTY(m_nPostponeFireReadyTicks,entity2::GameTick_t , 0x19dc);
			PROPERTY(m_flPostponeFireReadyFrac,float32 , 0x19e0);
			PROPERTY(m_bInReload,bool , 0x19e4);
			PROPERTY(m_flDroppedAtTime,entity2::GameTime_t , 0x19e8);
			PROPERTY(m_bIsHauledBack,bool , 0x19ec);
			PROPERTY(m_bSilencerOn,bool , 0x19ed);
			PROPERTY(m_flTimeSilencerSwitchComplete,entity2::GameTime_t , 0x19f0);
			...
			PROPERTY(m_nextPrevOwnerUseTime,entity2::GameTime_t , 0x1ab0);
			PROPERTY(m_hPrevOwner,GlobalTypes::CHandle<client::C_CSPlayerPawn>, 0x1ab4);
			PROPERTY(m_nDropTick,entity2::GameTick_t , 0x1ab8);
			PROPERTY(m_bWasActiveWeaponWhenDropped,bool , 0x1abc);
			PROPERTY(m_donated,bool , 0x1adc);
			PROPERTY(m_fLastShotTime,entity2::GameTime_t , 0x1ae0);
			...
			PROPERTY(m_IronSightController,client::C_IronSightController , 0x1c50);
			PROPERTY(m_iIronSightMode,int32_t , 0x1d00);
			PROPERTY(m_flLastLOSTraceFailureTime,entity2::GameTime_t , 0x1d18);
			PROPERTY(m_flWatTickOffset,float32 , 0x1d78);
			PROPERTY(m_flLastShakeTime,entity2::GameTime_t , 0x1d8c);
			S2_PAD(0x648);
		};
