...
namespace CS2 {
	namespace client {
		...
		public:
			...
			PROPERTY(m_flHealthShotBoostExpirationTime,entity2::GameTime_t , 0x1690);
			PROPERTY(m_flLastFiredWeaponTime,entity2::GameTime_t , 0x1694);
			...
			PROPERTY(m_aimPunchTickBase,entity2::GameTick_t , 0x16e4);
			...
			PROPERTY(m_flTimeOfLastInjury,entity2::GameTime_t , 0x171c);
			PROPERTY(m_flNextSprayDecalTime,entity2::GameTime_t , 0x1720);
			...
			PROPERTY(m_EconGloves,client::C_EconItemView , 0x1890);
			...
			PROPERTY(m_lastLandTime,entity2::GameTime_t , 0x23e0);
			...
			PROPERTY(m_fSwitchedHandednessTime,entity2::GameTime_t , 0x2414);
			...
			PROPERTY(m_vecBulletHitModels,GlobalTypes::CUtlVector<client::C_BulletHitModel*>, 0x24b0);
			...
			PROPERTY(m_entitySpottedState,client::EntitySpottedState_t , 0x26e0);
			...
			PROPERTY(m_flEmitSoundTime,entity2::GameTime_t , 0x2700);
			...
			PROPERTY(m_grenadeParameterStashTime,entity2::GameTime_t , 0x2754);
			...
			PROPERTY(m_nPrevHighestReceivedDamageTagTick,entity2::GameTick_t , 0x2830);
			PROPERTY(m_nHighestAppliedDamageTagTick,int32_t , 0x2834);
			PROPERTY(m_bShouldAutobuyDMWeapons,bool , 0x3d6c);
			PROPERTY(m_fImmuneToGunGameDamageTime,entity2::GameTime_t , 0x3d70);
			PROPERTY(m_bGunGameImmunity,bool , 0x3d74);
			PROPERTY(m_fImmuneToGunGameDamageTimeLast,entity2::GameTime_t , 0x3d78);
			...
			PROPERTY(m_nPlayerInfernoBodyFx,client::ParticleIndex_t , 0x3dc8);
