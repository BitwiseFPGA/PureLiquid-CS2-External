...
namespace CS2 {
	namespace client {
		...
		public:
			...
			PROPERTY(m_nAttachment,modellib::AttachmentHandle_t , 0xe94);
			PROPERTY(m_flSpriteFramerate,float32 , 0xe98);
			PROPERTY(m_flFrame,float32 , 0xe9c);
			PROPERTY(m_flDieTime,entity2::GameTime_t , 0xea0);
