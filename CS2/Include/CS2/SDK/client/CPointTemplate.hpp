...
namespace CS2 {
	namespace client {
		...
		public:
			...
			PROPERTY(m_createdSpawnGroupHandles,GlobalTypes::CUtlVector< uint32 >, 0x630);
			PROPERTY(m_SpawnedEntityHandles,GlobalTypes::CUtlVector<GlobalTypes::CEntityHandle>, 0x648);
