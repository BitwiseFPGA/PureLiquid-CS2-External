...
namespace CS2 {
	namespace server {
		...
		public:
			...
			PROPERTY(m_flTimeMovementStart,entity2::GameTime_t , 0x790);
			PROPERTY(m_flTimeMovementStop,entity2::GameTime_t , 0x794);
			...
			PROPERTY(m_OnMovementEnd,entity2::CEntityIOOutput , 0x7f8);
			...
			PROPERTY(m_flTimeStartOrientationChange,entity2::GameTime_t , 0x818);
			...
			PROPERTY(m_OnLerpToPositionComplete,entity2::CEntityIOOutput , 0x880);
			...
			PROPERTY(m_OnStart,entity2::CEntityIOOutput , 0x8d0);
			PROPERTY(m_OnStartForward,entity2::CEntityIOOutput , 0x8e8);
			PROPERTY(m_OnStartReverse,entity2::CEntityIOOutput , 0x900);
			PROPERTY(m_OnStop,entity2::CEntityIOOutput , 0x918);
			PROPERTY(m_OnStopped,entity2::CEntityIOOutput , 0x930);
			...
			PROPERTY(m_nTickMovementRan,entity2::GameTick_t , 0x994);
			S2_PAD(0x268);
		};
