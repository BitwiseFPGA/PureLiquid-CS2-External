...
namespace CS2 {
	namespace server {
		...
		public:
			...
			PROPERTY(m_hRemoveActorList,server::CUtlVector<GlobalTypes::CHandle<server::CBaseEntity>>, 0x570);
			PROPERTY(m_nSceneStringIndex,uint16_t , 0x5b8);
			PROPERTY(m_OnStart,entity2::CEntityIOOutput , 0x5c0);
			PROPERTY(m_OnCompletion,entity2::CEntityIOOutput , 0x5d8);
			PROPERTY(m_OnCanceled,entity2::CEntityIOOutput , 0x5f0);
			PROPERTY(m_OnPaused,entity2::CEntityIOOutput , 0x608);
			PROPERTY(m_OnResumed,entity2::CEntityIOOutput , 0x620);
			...
			PROPERTY(m_hNotifySceneCompletion,server::CUtlVector<GlobalTypes::CHandle<server::CSceneEntity>>, 0x6d8);
			PROPERTY(m_hListManagers,server::CUtlVector<GlobalTypes::CHandle<server::CSceneListManager>>, 0x6f0);
