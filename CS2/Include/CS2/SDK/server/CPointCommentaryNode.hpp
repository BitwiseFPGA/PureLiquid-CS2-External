...
namespace CS2 {
	namespace server {
		...
		public:
			...
			PROPERTY(m_flFinishedTime,entity2::GameTime_t , 0xa5c);
			...
			PROPERTY(m_flAbortedPlaybackAt,entity2::GameTime_t , 0xa94);
			PROPERTY(m_pOnCommentaryStarted,entity2::CEntityIOOutput , 0xa98);
			PROPERTY(m_pOnCommentaryStopped,entity2::CEntityIOOutput , 0xab0);
			PROPERTY(m_bActive,bool , 0xac8);
			PROPERTY(m_flStartTime,entity2::GameTime_t , 0xacc);
