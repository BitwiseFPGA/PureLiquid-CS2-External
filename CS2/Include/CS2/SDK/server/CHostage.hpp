...
namespace CS2 {
	namespace server {
		...
		public:
			PROPERTY(m_OnHostageBeginGrab,entity2::CEntityIOOutput , 0xb98);
			PROPERTY(m_OnFirstPickedUp,entity2::CEntityIOOutput , 0xbb0);
			PROPERTY(m_OnDroppedNotRescued,entity2::CEntityIOOutput , 0xbc8);
			PROPERTY(m_OnRescued,entity2::CEntityIOOutput , 0xbe0);
			PROPERTY(m_entitySpottedState,server::EntitySpottedState_t , 0xbf8);
			...
			PROPERTY(m_reuseTimer,server::CountdownTimer , 0xc40);
			...
			PROPERTY(m_jumpTimer,server::CountdownTimer , 0xc70);
			PROPERTY(m_isWaitingForLeader,bool , 0xc88);
			PROPERTY(m_repathTimer,server::CountdownTimer , 0x2c98);
			PROPERTY(m_inhibitDoorTimer,server::CountdownTimer , 0x2cb0);
			PROPERTY(m_inhibitObstacleAvoidanceTimer,server::CountdownTimer , 0x2d40);
			PROPERTY(m_wiggleTimer,server::CountdownTimer , 0x2d60);
			...
			PROPERTY(m_fLastGrabTime,entity2::GameTime_t , 0x2d84);
			...
			PROPERTY(m_flRescueStartTime,entity2::GameTime_t , 0x2da0);
			PROPERTY(m_flGrabSuccessTime,entity2::GameTime_t , 0x2da4);
			PROPERTY(m_flDropStartTime,entity2::GameTime_t , 0x2da8);
