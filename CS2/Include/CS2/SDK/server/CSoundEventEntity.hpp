...
namespace CS2 {
	namespace server {
		...
		public:
			...
			// PROPERTY(m_onGUIDChanged,IDENTITY(GlobalTypes::CEntityOutputTemplate< uint64, uint64 >), 0x4c8);
			NESTED_PROPERTY(m_onSoundFinished,IDENTITY(entity2::CEntityIOOutput), 0x4e8);
