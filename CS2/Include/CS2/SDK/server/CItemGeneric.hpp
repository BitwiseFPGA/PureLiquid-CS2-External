...
namespace CS2 {
	namespace server {
		...
		public:
			...
			PROPERTY(m_flLastPickupCheck,entity2::GameTime_t , 0xae0);
			...
			PROPERTY(m_OnPickup,entity2::CEntityIOOutput , 0xb48);
			PROPERTY(m_OnTimeout,entity2::CEntityIOOutput , 0xb60);
			PROPERTY(m_OnTriggerStartTouch,entity2::CEntityIOOutput , 0xb78);
			PROPERTY(m_OnTriggerTouch,entity2::CEntityIOOutput , 0xb90);
			PROPERTY(m_OnTriggerEndTouch,entity2::CEntityIOOutput , 0xba8);
