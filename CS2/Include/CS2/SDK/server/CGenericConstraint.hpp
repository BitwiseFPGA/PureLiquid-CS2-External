...
namespace CS2 {
	namespace server {
		...
		public:
			...
			PROPERTY(m_flBreakAfterTimeStartTimeX,entity2::GameTime_t , 0x54c);
			PROPERTY(m_flBreakAfterTimeStartTimeY,entity2::GameTime_t , 0x550);
			PROPERTY(m_flBreakAfterTimeStartTimeZ,entity2::GameTime_t , 0x554);
			...
			PROPERTY(m_flNotifyForceLastTimeX,entity2::GameTime_t , 0x57c);
			PROPERTY(m_flNotifyForceLastTimeY,entity2::GameTime_t , 0x580);
			PROPERTY(m_flNotifyForceLastTimeZ,entity2::GameTime_t , 0x584);
			...
			PROPERTY(m_NotifyForceReachedX,entity2::CEntityIOOutput , 0x5c0);
			PROPERTY(m_NotifyForceReachedY,entity2::CEntityIOOutput , 0x5d8);
			PROPERTY(m_NotifyForceReachedZ,entity2::CEntityIOOutput , 0x5f0);
			S2_PAD(0x100);
		};
