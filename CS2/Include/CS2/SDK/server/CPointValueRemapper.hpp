...
namespace CS2 {
	namespace server {
		...
		public:
			...
			PROPERTY(m_flPreviousUpdateTickTime,entity2::GameTime_t , 0x540);
			...
			PROPERTY(m_OnReachedValueZero,entity2::CEntityIOOutput , 0x5d8);
			PROPERTY(m_OnReachedValueOne,entity2::CEntityIOOutput , 0x5f0);
			PROPERTY(m_OnReachedValueCustom,entity2::CEntityIOOutput , 0x608);
			PROPERTY(m_OnEngage,entity2::CEntityIOOutput , 0x620);
			PROPERTY(m_OnDisengage,entity2::CEntityIOOutput , 0x638);
			S2_PAD(0x1A8);
		};
