...
namespace CS2 {
	namespace server {
		...
		public:
			PROPERTY(m_MotionEnabled,entity2::CEntityIOOutput , 0xbb0);
			PROPERTY(m_OnAwakened,entity2::CEntityIOOutput , 0xbc8);
			PROPERTY(m_OnAwake,entity2::CEntityIOOutput , 0xbe0);
			PROPERTY(m_OnAsleep,entity2::CEntityIOOutput , 0xbf8);
			PROPERTY(m_OnPlayerUse,entity2::CEntityIOOutput , 0xc10);
			PROPERTY(m_OnOutOfWorld,entity2::CEntityIOOutput , 0xc28);
			PROPERTY(m_OnPlayerPickup,entity2::CEntityIOOutput , 0xc40);
			...
			PROPERTY(m_flLastBurn,entity2::GameTime_t , 0xc78);
			PROPERTY(m_nDynamicContinuousContactBehavior,physicslib::DynamicContinuousContactBehavior_t , 0xc7c);
			PROPERTY(m_fNextCheckDisableMotionContactsTime,entity2::GameTime_t , 0xc80);
