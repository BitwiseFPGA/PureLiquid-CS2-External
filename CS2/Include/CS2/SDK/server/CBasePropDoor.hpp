...
namespace CS2 {
	namespace server {
		...
		public:
			...
			PROPERTY(m_hDoorList,server::CUtlVector<GlobalTypes::CHandle<server::CBasePropDoor>>, 0xc68);
			...
			PROPERTY(m_ls,server::locksound_t , 0xcb0);
			...
			PROPERTY(m_OnBlockedClosing,entity2::CEntityIOOutput , 0xd58);
			PROPERTY(m_OnBlockedOpening,entity2::CEntityIOOutput , 0xd70);
			PROPERTY(m_OnUnblockedClosing,entity2::CEntityIOOutput , 0xd88);
			PROPERTY(m_OnUnblockedOpening,entity2::CEntityIOOutput , 0xda0);
			PROPERTY(m_OnFullyClosed,entity2::CEntityIOOutput , 0xdb8);
			PROPERTY(m_OnFullyOpen,entity2::CEntityIOOutput , 0xdd0);
			PROPERTY(m_OnClose,entity2::CEntityIOOutput , 0xde8);
			PROPERTY(m_OnOpen,entity2::CEntityIOOutput , 0xe00);
			PROPERTY(m_OnLockedUse,entity2::CEntityIOOutput , 0xe18);
			PROPERTY(m_OnAjarOpen,entity2::CEntityIOOutput , 0xe30);
			S2_PAD(0x200);
		};
