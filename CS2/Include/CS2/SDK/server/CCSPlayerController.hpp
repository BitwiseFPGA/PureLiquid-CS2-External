...
namespace CS2 {
	namespace server {
		...
		public:
			...
			PROPERTY(m_flForceTeamTime,entity2::GameTime_t , 0x814);
			...
			PROPERTY(m_flLastJoinTeamTime,entity2::GameTime_t , 0x82c);
			...
			PROPERTY(m_lastHeldVoteTimer,server::IntervalTimer , 0x940);
			...
			PROPERTY(m_LastTeamDamageWarningTime,entity2::GameTime_t , 0x970);
			PROPERTY(m_LastTimePlayerWasDisconnectedForPawnsRemove,entity2::GameTime_t , 0x974);
