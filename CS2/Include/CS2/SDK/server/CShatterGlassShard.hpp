...
namespace CS2 {
	namespace server {
		...
		public:
			...
			PROPERTY(m_vecPanelVertices,GlobalTypes::CUtlVector<GlobalTypes::Vector2D>, 0x10);
			...
			PROPERTY(m_flPhysicsEntitySpawnedAtTime,entity2::GameTime_t , 0x98);
			PROPERTY(m_hEntityHittingMe,GlobalTypes::CHandle<server::CBaseEntity>, 0x9c);
			PROPERTY(m_vecNeighbors,GlobalTypes::CUtlVector< uint32 >, 0xa0);
			S2_PAD(0xB8);
		};
