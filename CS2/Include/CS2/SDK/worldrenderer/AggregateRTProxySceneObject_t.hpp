...
namespace CS2 {
	namespace worldrenderer {
		...
		public:
			...
			PROPERTY(m_BLASes,GlobalTypes::CUtlVector<worldrenderer::RTProxyBLAS_t>, 0x8);
			PROPERTY(m_Instances,GlobalTypes::CUtlVector<worldrenderer::RTProxyInstanceInfo_t>, 0x20);
