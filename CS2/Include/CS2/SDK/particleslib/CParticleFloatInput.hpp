...
namespace CS2 {
	namespace particleslib {
		...
		public:
			...
			PROPERTY(m_nScalarAttribute,particles::ParticleAttributeIndex_t , 0x64);
			PROPERTY(m_nVectorAttribute,particles::ParticleAttributeIndex_t , 0x68);
			...
			PROPERTY(m_nNoiseInputVectorAttribute,particles::ParticleAttributeIndex_t , 0xa8);
