...
namespace CS2 {
	namespace animlib {
		...
		public:
			PROPERTY(m_translationRangeX,animlib::QuantizationRange_t , 0x0);
			PROPERTY(m_translationRangeY,animlib::QuantizationRange_t , 0x8);
			PROPERTY(m_translationRangeZ,animlib::QuantizationRange_t , 0x10);
			PROPERTY(m_scaleRange,animlib::QuantizationRange_t , 0x18);
