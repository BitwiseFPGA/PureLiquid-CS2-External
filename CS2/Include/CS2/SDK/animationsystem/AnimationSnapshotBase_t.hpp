...
namespace CS2 {
	namespace animationsystem {
		...
		public:
			...
			PROPERTY(m_boneSetupMask,GlobalTypes::CUtlVector< uint32 >, 0x48);
			PROPERTY(m_boneTransforms,GlobalTypes::CUtlVector<GlobalTypes::matrix3x4a_t>, 0x60);
			PROPERTY(m_flexControllers,GlobalTypes::CUtlVector< float32 >, 0x78);
			PROPERTY(m_SnapshotType,animationsystem::AnimationSnapshotType_t , 0x90);
			PROPERTY(m_bHasDecodeDump,bool , 0x94);
			PROPERTY(m_DecodeDump,animationsystem::AnimationDecodeDebugDumpElement_t , 0x98);
			S2_PAD(0x110);
		};
